...
enable_repo "ol7_latest"
#enable_repo "ol7_addons"
#enable_repo "ol7_software_collections"

OL7_ADDONS_REPO_CONF=$(cat <<'EOF'
[ol7_addons]
...
add_repo_as_file 'ol7-addons' "$OL7_ADDONS_REPO_CONF"
add_repo_as_file 'ol7-software-collections' "$OL7_SC_REPO_CONF"
...
# for postgresql10
if ! is_package_installed 'pgdg-redhat-repo.noarch'; then
	install_package 'https://download.postgresql.org/pub/repos/yum/reporpms/EL-7-x86_64/pgdg-redhat-repo-latest.noarch.rpm' 'pgdg-redhat-repo.noarch'
fi
